...
{
    public async Task CreateMvTagStatistics()
    {
        var query = """
    ...
    public async Task RefreshMvTagStatistics()
    {
        await context.Database.ExecuteSqlRawAsync("REFRESH MATERIALIZED VIEW mv_tag_statistics;");
    }
    ...
    public async Task CreateDefaultTags()
    {
        ...
        await context.Tag.AddRangeAsync(defaultTags);
        await context.SaveChangesAsync();
    }
}