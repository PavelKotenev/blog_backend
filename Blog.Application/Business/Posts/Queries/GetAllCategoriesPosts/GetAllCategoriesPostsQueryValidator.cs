...
public partial class GetAllCategoriesPostsQueryValidator: AbstractValidator<GetAllCategoriesPostsQuery>
{
    public GetAllCategoriesPostsQueryValidator()
    {
    ...
    {
        return IsValidSearchTermRegex().IsMatch(queryString);
    }
